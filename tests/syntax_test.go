...
func TestGetNextASTFunctionInFunction(t *testing.T) {
    ...
    expected := &i.AST{
        ...
        Right: &i.AST{
            Left: &i.AST{
                Left: &i.AST{Value: &i.Token{"g", i.IDENTIFIER}},
                Right: &i.AST{Value: &i.Token{"x", i.IDENTIFIER}},
                Value: &i.Token{"", i.SPECIAL_FUNCTION_CALL},
            },
            Right: &i.AST{
                Left: &i.AST{Value: &i.Token{"h", i.IDENTIFIER}},
                Right: &i.AST{Value: &i.Token{"y", i.IDENTIFIER}},
                Value: &i.Token{"", i.SPECIAL_FUNCTION_CALL},
            },
            Value: &i.Token{"+", i.SIGN},
    ...
    expected := &i.AST{
        Left: &i.AST{
            Left: &i.AST{
                Left: &i.AST{
                    Left: &i.AST{Value: &i.Token{"x", i.IDENTIFIER}},
                    Right: &i.AST{Value: &i.Token{"f", i.IDENTIFIER}},
                    Value: &i.Token{".", i.SIGN},
                },
                Right: &i.AST{Value: &i.Token{"a", i.IDENTIFIER}},
                Value: &i.Token{"", i.SPECIAL_FUNCTION_CALL},
            },
            Right: &i.AST{Value: &i.Token{"g", i.IDENTIFIER}},
            Value: &i.Token{".", i.SIGN},
        },
        Right: &i.AST{Value: &i.Token{"b", i.IDENTIFIER}},
        Value: &i.Token{"", i.SPECIAL_FUNCTION_CALL},
...
func TestGetNextASTInheritance(t *testing.T) {
    ...
    expected := &i.AST{
        Left: &i.AST{
            Left: &i.AST{Value: &i.Token{"T", i.IDENTIFIER}},
            Right: &i.AST{Value: &i.Token{"P", i.IDENTIFIER}},
            Value: &i.Token{":", i.SIGN},
        },
		Right: &i.AST{
			Left: &i.AST{
